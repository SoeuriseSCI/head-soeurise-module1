...
4. CUTOFF_HONORAIRES: 622€ honoraires cutoff 31/12
5. CUTOFF_SCPI: 7356€ revenus cutoff 31/12
...
## 🔧 Robustification Détection Exercice (8 commits PR #330-#338)
**Critères stabilisés:**
- Exercice = plus RÉCENT OUVERT (DESC SQL order)
- SQL statut='OUVERT' (robuste vs date_cloture NULL ambigü)
- Détection exercice ANCIEN non clôturé (flexibilité année-agnostique)
- Type affichage: Spécifique (CUTOFF_HONORAIRES) vs générique (CUTOFF)
