...
NE retourne QUE le JSON, sans texte avant ou après."""
    ...
    def _construire_prompt_unifie(self, sections_ordonnees: List[Dict]) -> str:
        ...
        prompt_parts.extend([
            ...
            "",
            "CRITIQUE - EXTRACTION EXHAUSTIVE:",
            "- Extrais TOUTES les opérations sans exception",
            "- N'oublie AUCUNE opération récurrente mensuelle:",
            "  * Toutes les assurances prêt (CACI NON LIFE LIMITED - 21.22€, 67.30€, 66.58€, 20.99€ chaque mois)",
            "  * Tous les frais bancaires mensuels (LCL ACCESS, COTISATION OPTION PRO, REMISES)",
            "  * Tous les remboursements de prêts immobiliers (258.33€ et 1166.59€ chaque mois)",
            "  * Tous les achats de valeurs mobilières (ETF, actions Amazon)",
            "  * Toutes les distributions SCPI",
            "- Regroupe les opérations multi-lignes",
            "- Ignore uniquement: en-têtes de colonnes, lignes de totaux, soldes d'ouverture/clôture",
            "",
