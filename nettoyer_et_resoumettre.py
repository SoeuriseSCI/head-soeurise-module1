...
def afficher_instructions_resoumission():
    ...
    print("=" * 80)
    print()
    print("⚠️  IMPORTANT: Vérifier le gap octobre entre Q1-Q3 et Q4")
    print()
    print("1️⃣  ANALYSER LES FICHIERS PDF:")
    print("    - Fichier Q1-Q3 : Quelle est la dernière date ?")
    print("    - Fichier Q4 : Quelle est la première date ?")
    print("    - Y a-t-il un gap entre les deux ?")
    print()
    print("2️⃣  SI GAP DÉTECTÉ:")
    print("    - Demander à la banque le relevé manquant")
    print("    - OU extraire manuellement les opérations manquantes")
    print()
    print("3️⃣  RESOUMISSION DANS L'ORDRE:")
    print("    a) Soumettre Q1-Q3 complet")
    print("    b) Soumettre relevé gap octobre (si nécessaire)")
    print("    c) Soumettre Q4 complet")
    print()
