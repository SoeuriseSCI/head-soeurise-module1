#!/usr/bin/env python3
"""
Construction des états financiers 2025
- Bilan 2025 (Actif / Passif)
- Compte d'exploitation 2025 (Produits / Charges)
...
print("="*80)
print("📊 CONSTRUCTION ÉTATS FINANCIERS 2025")
print("="*80)

# Récupérer l'exercice 2025
...
# TOUTES les écritures 2025 (ouverture + flux)
...
# ==============================================================================
# ÉTAPE 2 : COMPTE DE RÉSULTAT 2025
# ==============================================================================

print("\n" + "="*80)
print("ÉTAPE 2 : COMPTE DE RÉSULTAT 2025")
print("="*80)
...
print("\n🎯 RÉSULTAT DE L'EXERCICE 2025 (AVANT IMPÔT)")
print("-"*80)
...
# ==============================================================================
# ÉTAPE 3 : BILAN AU 31/12/2025
# ==============================================================================

print("\n" + "="*80)
print("ÉTAPE 3 : BILAN AU 31/12/2025")
print("="*80)
...
print("-"*80)
if resultat >= 0:
    print(f"{'12X':<10} {'Résultat de exercice 2025 (bénéfice)':<40} {resultat:>14.2f}€")
    ...
    print(f"{'12X':<10} {'Résultat de exercice 2025 (perte)':<40} {abs(resultat):>14.2f}€")
...
export = {
    ...
    "exercice": {
        "annee": 2025,
        "date_debut": str(exercice_2025.date_debut),
        "date_fin": str(exercice_2025.date_fin),
        "statut": exercice_2025.statut
    },
    "compte_resultat": {
        "charges": {
            num: {
...
output_file = f"etats_financiers_2025_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
...
🎯 PROCHAINES ÉTAPES :
   ...
   3. Si OK : Provisionner impôt sur les sociétés
   4. Continuer suivi exercice 2025
   5. Préparer clôture 2025 (en fin d'année)
""")
